...
GREEN_SOUND = pygame.mixer.Sound("project/assets/bell1.mp3") # bell1
RED_SOUND = pygame.mixer.Sound("project/assets/bell2.mp3") # bell2
BLUE_SOUND = pygame.mixer.Sound("project/assets/bell3.mp3") # bell3
YELLOW_SOUND = pygame.mixer.Sound("project/assets/bell4.mp3") # bell4
